...
//
//import com.example.springsecurity.bo.RolePermissionBO;
...
////        List<RolePermissionBO> rolePermissionBOS = permissionMapper.getRolePermissions();
////        //某个资源 可以被哪些角色访问
////        for (RolePermissionBO rolePermisson : rolePermissionBOS) {
